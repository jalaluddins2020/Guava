...
app = Flask(__name__)
app.config['SQLALCHEMY_DATABASE_URI'] = environ.get('dbURL') or 'mysql+mysqlconnector://root@localhost:3306/payment_recordsdb'
...
if __name__ == '__main__':
    print("This is " + os.path.basename(__file__) + "  - the payments microservice")
